                        ...
                        <div class="card rounded">
                            ...
                            <div class="card-body">
                                ...
                                @if (!empty($post->post_photo))
                                    <img class="img-fluid post-image" src="{{ url('upload/posts/' . $post->post_photo) }}"
                                        alt="">
                                @endif
                                <div class="mt-3">
                            ...
                            <div class="card-footer">
                                <div class="d-flex post-actions">
                                    ...
                                    <a class="d-flex align-items-center text-muted me-4 collapsed" data-bs-toggle="collapse"
                                        data-bs-target="#answer_{{ $post->id }}" aria-expanded="false"
                                        aria-controls="answer_{{ $post->id }}">
                                ...
                                <div class="card-body">
                                    <div class="accordion-body">
                                        ...
                                        <form class="forms-sample" method="POST"
                                            action="{{ route('store.answer', $post->id) }}" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <button type="submit" class="btn btn-primary text-dark">Send</button>
